# coding:utf-8
# @Author:xb
# @Time: 2024/2/23 17:24
# @File:Top200douban.py
#!/usr/bin/env python
# encoding=utf-8
import requests
import re
...
def get_li(doc):
    ...
    for i in ol.find_all('li'):
        ...
        star_num = star.find(text=re.compile('评价'))  # 评价#content > div > div.article > ol > li:nth-child(1) > div > div.info > div.bd > div > span:nth-child(4)
